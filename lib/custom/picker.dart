...
//Flutter Cupertino SDK
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';

/// Color of the 'magnifier' lens border.
const Color _kHighlighterBorder = Colors.transparent;
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              colors: <Color>[
                ...
                // widgetBackgroundColor.withAlpha(0x99),
                // widgetBackgroundColor.withAlpha(0x80),
                widgetBackgroundColor.withAlpha(0xC4),
